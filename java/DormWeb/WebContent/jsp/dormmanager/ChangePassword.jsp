...
<script src="${pageContext.request.contextPath}/style/js/dormmanager/CPassword.js"></script>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li class="active"><a href="${pageContext.request.contextPath }/jsp/dormmanager/ChangePassword.jsp">修改密码</a></li>
    ...
    <div class="row">
		...
		<div id="right_container" class="container col-md-offset-2 col-md-6 wow fadeInRight" style="margin-top: 20px;" >
		    ...
		    <div class="panel-body row">
	           <form class="form-signin  col-sm-offset-3 col-sm-6" id="formcp" action="${pageContext.request.contextPath }/DMCPServlet" method="post">
