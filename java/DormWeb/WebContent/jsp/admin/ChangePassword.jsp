...
<script src="${pageContext.request.contextPath}/style/js/admin/CPassword.js"></script>
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li class="active"><a href="${pageContext.request.contextPath }/jsp/admin/ChangePassword.jsp">修改密码</a></li>
    ...
    <div class="row">
		...
		<div id="right_container" class="container col-md-offset-2 col-md-6 wow fadeInRight" style="margin-top: 20px;" >
		    ...
		    <div class="panel-body row">
	           <form class="form-signin  col-sm-offset-3 col-sm-6" id="formcp" action="${pageContext.request.contextPath }/AdminCPServlet" method="post">
					<input type="hidden" id="AdminId" name="AdminId" value="<%=session.getAttribute("AdminId") %>" /> 
